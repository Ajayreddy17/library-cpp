#ifndef AJAY_INPUT_STREAM
#define AJAY_INPUT_STREAM
...
namespace mitsuha::io {
    ...
    public:
        ...
        template <typename T> InputStream& operator>>(T& e) {
            if constexpr (mitsuha::is_readable_v<T>) is >> e; else _read(e);
            return *this;
        }
...
namespace mitsuha { using io::read; } // namespace mitsuha
#endif // AJAY_INPUT_STREAM